  ...
  return (
    <div className='bg-white'>
      ...
      <div onClick={() => setShowMenu(false)}>
        <div id='orderdesign' className='pt-16 mob:w-[343px] sm:w-[568px] lg:w-[900px] xl:w-[1256px] m-auto'>
          <Hero/>
        </div>
        <div id='services' className='pb-16 lg:pb-28 xl:pb-20'>
        ...
        <div id='portfolio'>
          ...
          <div className='flex pb-6 xl:pb-[72px] h-[480px] sm:h-[680px] lg:h-[600px] xl:h-[816px] bg-projects bg-no-repeat bg-cover'>
            <button className='p-4 sm:px-8 lg:py-8 text-xl sm:text-2xl lg:text-[27px] xl:text-[32px] font-bold text-white bg-black m-auto mb-0 rounded-full shadow-button cursor-pointer'>All projects</button>
          </div>
        </div>
